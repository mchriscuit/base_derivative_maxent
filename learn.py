...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--data', '-d', type=str, nargs='?',
        help='Name of data file.'
        )
    parser.add_argument(
        '--constraints', '-c', type=str, nargs='?',
        help='Name of constraints file.'
        )
    parser.add_argument(
        '--iterations', '-i', type=int, nargs='?', default=10000,
    ...
    model = bd.BDMaxEnt(inputs, candidates, winner_idxs, lexemes,
                        names, types, definitions, weights)
